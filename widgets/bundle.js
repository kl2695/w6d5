  ...
  _createClass(Content, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_tabs2.default, { tabs: [{ title: 'tab1', content: 'watsup im tab1' }, { title: 'tab2', content: 'heyoooo im tab2 im better' }, { title: 'tab3', content: 'you will never get this' }] }),
        _react2.default.createElement(_autocomplete2.default, { list: ['Abba', 'Barney', 'Barbara', 'Jeff', 'Jenny', 'Sarah', 'Sally', 'Xander'] })
      );
    }
  }]);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  _reactDom2.default.render(_react2.default.createElement(Content, null), root);
});
...
var Tabs = function (_React$Component) {
  ...
  _createClass(Tabs, [{
    key: 'reassign',
    value: function reassign(tab) {
      var _this2 = this;

      return function (event) {
        return _this2.setState({ selected: _this2.tabs.indexOf(tab) });
      };
    }
  }, {
    key: 'render',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.tabs.map(function (tab) {
            return _react2.default.createElement(
              'button',
              { key: tab.title, onClick: _this3.reassign(tab) },
              tab.title
            );
          })
        ),
        _react2.default.createElement(
          'p',
          null,
          this.tabs[this.state.selected].content
        )
      );
    }
  }]);
...
var Autocomplete = function (_React$Component) {
  ...
  _createClass(Autocomplete, [{
    key: "receivesText",
    value: function receivesText() {
      var _this2 = this;

      return function (event) {
        return _this2.setState({ inputVal: event.currentTarget.value });
      };
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var names = this.list.filter(function (name) {
        return name.includes(_this3.state.inputVal);
      });
      return _react2.default.createElement(
        "div",
        null,
        _react2.default.createElement("input", { type: "text", onChange: this.receivesText() }),
        _react2.default.createElement(
          "ul",
          null,
